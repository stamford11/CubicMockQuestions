...
public class QuestionsMethods {
	...
	public static void main(String[] args) {
		...
		System.out.println("=-=-=-=-=-=-=-=-=-=-=-=-=-=");
		QuestionsMethods.factorialGen(5);
		System.out.println("=-=-=-=-=-=-=-=-=-=-=-=-=-=");
		QuestionsMethods.sumOfDoubleInt(100, 400.00);
		System.out.println("=-=-=-=-=-=-=-=-=-=-=-=-=-=");
		QuestionsMethods.countVowel("Java Is amazing");
		System.out.println("=-=-=-=-=-=-=-=-=-=-=-=-=-=");
		QuestionsMethods.countLetter("kokololomomososo");
